// Deploy the Quorum contract to GenLayer Testnet Bradbury using
...
const CONTRACT_PATH = join(__dirname, '..', 'contract', 'quorum.py');
...
async function main() {
  ...
  console.log('Deploying Quorum to Testnet Bradbury…');
